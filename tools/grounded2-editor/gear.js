(() => {
  ...
  const WEAPON_RE =
    /Axe|Sword|Bow|Club|Spear|Staff|Dagger|Blade|CrossBow|Trident|Scythe|Mace|Hammer|Warhammer|Fist|Prod|Shatter|Paddle|Bat|Mallet|Katana|Rapier|Halberd|Whacker|Smacker|Reaper|Shovel|Crow|AntClub|Bone|Quartzite|Tiger|Toenail|Widow|Larva|Tick|Koi|Mosquito|Stinger|Pebblet|Sprig|Broodmother|BlackOx|FireAnt|BlackAnt|RedAnt|Infected|Venom|Fang|Pinch|LawnFang|Omni|Buggy|Pike|Lancer|Cleaver|Saber|Maul/i;
  const ARMOR_RE =
    /^(Head|Chest|Legs)|Armor|Mask|Helmet|Pauldron|Greaves|Vambrace|Glider|BubbleHelmet|GasMask|Rebreather|Faceplate|Shin|Cuirass|Cap|Hood|Boot|Pad$|Pads$/i;
