...
// Function WebBrowserWidget.WebBrowser.ForceFocusToBrowserViewport
// (Final, Native, Public, BlueprintCallable)

void UWebBrowser::ForceFocusToBrowserViewport()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WebBrowser", "ForceFocusToBrowserViewport");
