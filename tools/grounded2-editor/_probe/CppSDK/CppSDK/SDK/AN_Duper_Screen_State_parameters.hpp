...
// Function AN_Duper_Screen_State.AN_Duper_Screen_State_C.Received_NotifyBegin
// 0x0080 (0x0080 - 0x0000)
struct AN_Duper_Screen_State_C_Received_NotifyBegin final
{
public:
	...
	class ABP_SurvivalPlayerCharacter_C*          K2Node_DynamicCast_AsBP_Survival_Player_Character; // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ASurvivalPlayerController*              CallFunc_GetSurvivalPlayerController_ReturnValue;  // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ABP_ItemDuplicator_C*                   K2Node_DynamicCast_AsBP_Item_Duplicator;           // 0x0070(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_AN_Duper_Screen_State_C_Received_NotifyBegin;

// Function AN_Duper_Screen_State.AN_Duper_Screen_State_C.Received_NotifyEnd
// 0x0078 (0x0078 - 0x0000)
struct AN_Duper_Screen_State_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_ItemDuplicator_C*                   K2Node_DynamicCast_AsBP_Item_Duplicator;           // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_AN_Duper_Screen_State_C_Received_NotifyEnd;
