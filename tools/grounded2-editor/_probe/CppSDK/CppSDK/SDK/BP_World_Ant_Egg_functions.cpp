...
#include "BP_World_Ant_Egg_classes.hpp"
#include "BP_World_Ant_Egg_parameters.hpp"
...
void ABP_World_Ant_Egg_C::ExecuteUbergraph_BP_World_Ant_Egg(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_World_Ant_Egg_C", "ExecuteUbergraph_BP_World_Ant_Egg");

	Params::BP_World_Ant_Egg_C_ExecuteUbergraph_BP_World_Ant_Egg Parms{};
...
void ABP_World_Ant_Egg_C::Interact(EInteractionChannel Channel, class AActor* InstigatedBy)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_World_Ant_Egg_C", "Interact");

	Params::BP_World_Ant_Egg_C_Interact Parms{};
