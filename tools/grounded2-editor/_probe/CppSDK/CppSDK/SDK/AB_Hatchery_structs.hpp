...
// ScriptStruct AB_Hatchery.AB_Hatchery_C.AnimBlueprintGeneratedConstantData
// 0x01B7 (0x01B8 - 0x0001)
struct AB_Hatchery::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
	...
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_MeshRefPose;                    // 0x0158(0x0030)()
	struct FAnimNodeExposedValueHandler_PropertyAccess AnimGraphNode_ComponentToLocalSpace;          // 0x0188(0x0030)()
};
DUMPER7_ASSERTS_AB_Hatchery__FAnimBlueprintGeneratedConstantData;
