...
// ScriptStruct Foliage.OEIWodemFoliageTypeProperties
// 0x0014 (0x0014 - 0x0000)
struct FOEIWodemFoliageTypeProperties final
{
public:
	...
	float                                         GlobalRotation;                                    // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFloatInterval                         MinMaxRotation;                                    // 0x0008(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         NoiseValue;                                        // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FOEIWodemFoliageTypeProperties;
