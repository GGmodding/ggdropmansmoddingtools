...
// Class PlayFab.PlayFabAddonModelDecoder
// 0x0000 (0x0028 - 0x0028)
class UPlayFabAddonModelDecoder final : public UBlueprintFunctionLibrary
{
public:
	static struct FAddonCreateOrUpdateAppleResponse decodeCreateOrUpdateAppleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateFacebookInstantGamesResponse decodeCreateOrUpdateFacebookInstantGamesResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateFacebookResponse decodeCreateOrUpdateFacebookResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateGoogleResponse decodeCreateOrUpdateGoogleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateKongregateResponse decodeCreateOrUpdateKongregateResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateNintendoResponse decodeCreateOrUpdateNintendoResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdatePSNResponse decodeCreateOrUpdatePSNResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateSteamResponse decodeCreateOrUpdateSteamResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateToxModResponse decodeCreateOrUpdateToxModResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonCreateOrUpdateTwitchResponse decodeCreateOrUpdateTwitchResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteAppleResponse decodeDeleteAppleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteFacebookInstantGamesResponse decodeDeleteFacebookInstantGamesResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteFacebookResponse decodeDeleteFacebookResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteGoogleResponse decodeDeleteGoogleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteKongregateResponse decodeDeleteKongregateResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteNintendoResponse decodeDeleteNintendoResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeletePSNResponse decodeDeletePSNResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteSteamResponse decodeDeleteSteamResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteToxModResponse decodeDeleteToxModResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonDeleteTwitchResponse decodeDeleteTwitchResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetAppleResponse decodeGetAppleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetFacebookInstantGamesResponse decodeGetFacebookInstantGamesResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetFacebookResponse decodeGetFacebookResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetGoogleResponse decodeGetGoogleResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetKongregateResponse decodeGetKongregateResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetNintendoResponse decodeGetNintendoResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetPSNResponse decodeGetPSNResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetSteamResponse decodeGetSteamResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetToxModResponse decodeGetToxModResponseResponse(class UPlayFabJsonObject* Response);
	static struct FAddonGetTwitchResponse decodeGetTwitchResponseResponse(class UPlayFabJsonObject* Response);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabAddonModelDecoder")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabAddonModelDecoder")
	}
	static class UPlayFabAddonModelDecoder* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPlayFabAddonModelDecoder>();
	}
};
DUMPER7_ASSERTS_UPlayFabAddonModelDecoder;
...
public:
	...
	static struct FEconomyRedeemAppleAppStoreWithJwsInventoryItemsResponse decodeRedeemAppleAppStoreWithJwsInventoryItemsResponseResponse(class UPlayFabJsonObject* Response);
...
public:
	...
	static class UPlayFabEventsAPI* DeleteDataConnection(const struct FEventsDeleteDataConnectionRequest& Request, TDelegate<void(const struct FEventsDeleteDataConnectionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabEventsAPI* GetDataConnection(const struct FEventsGetDataConnectionRequest& Request, TDelegate<void(const struct FEventsGetDataConnectionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabEventsAPI* ListDataConnections(const struct FEventsListDataConnectionsRequest& Request, TDelegate<void(const struct FEventsListDataConnectionsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabEventsAPI* SetDataConnection(const struct FEventsSetDataConnectionRequest& Request, TDelegate<void(const struct FEventsSetDataConnectionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabEventsAPI* SetDataConnectionActive(const struct FEventsSetDataConnectionActiveRequest& Request, TDelegate<void(const struct FEventsSetDataConnectionActiveResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperDeleteDataConnection(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteTelemetryKey(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetDataConnection(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetTelemetryKey(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperListDataConnections(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperListTelemetryKeys(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperSetDataConnection(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperSetDataConnectionActive(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
public:
	...
	static struct FEventsDeleteDataConnectionResponse decodeDeleteDataConnectionResponseResponse(class UPlayFabJsonObject* Response);
	...
	static struct FEventsGetDataConnectionResponse decodeGetDataConnectionResponseResponse(class UPlayFabJsonObject* Response);
	static struct FEventsGetTelemetryKeyResponse decodeGetTelemetryKeyResponseResponse(class UPlayFabJsonObject* Response);
	static struct FEventsListDataConnectionsResponse decodeListDataConnectionsResponseResponse(class UPlayFabJsonObject* Response);
	static struct FEventsListTelemetryKeysResponse decodeListTelemetryKeysResponseResponse(class UPlayFabJsonObject* Response);
	static struct FEventsSetDataConnectionActiveResponse decodeSetDataConnectionActiveResponseResponse(class UPlayFabJsonObject* Response);
	static struct FEventsSetDataConnectionResponse decodeSetDataConnectionResponseResponse(class UPlayFabJsonObject* Response);
...
public:
	...
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0128(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UPlayFabProfilesAPI* SetDisplayName(const struct FProfilesSetDisplayNameRequest& Request, TDelegate<void(const struct FProfilesSetDisplayNameResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperSetDisplayName(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
public:
	...
	static struct FProfilesSetDisplayNameResponse decodeSetDisplayNameResponseResponse(class UPlayFabJsonObject* Response);
...
// Class PlayFab.PlayFabProgressionModelDecoder
// 0x0000 (0x0028 - 0x0028)
class UPlayFabProgressionModelDecoder final : public UBlueprintFunctionLibrary
{
public:
	static struct FProgressionDeleteStatisticsResponse decodeDeleteStatisticsResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionEmptyResponse decodeEmptyResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionGetEntityLeaderboardResponse decodeGetEntityLeaderboardResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionGetLeaderboardDefinitionResponse decodeGetLeaderboardDefinitionResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionGetStatisticDefinitionResponse decodeGetStatisticDefinitionResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionGetStatisticsForEntitiesResponse decodeGetStatisticsForEntitiesResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionGetStatisticsResponse decodeGetStatisticsResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionIncrementLeaderboardVersionResponse decodeIncrementLeaderboardVersionResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionIncrementStatisticVersionResponse decodeIncrementStatisticVersionResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionListLeaderboardDefinitionsResponse decodeListLeaderboardDefinitionsResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionListStatisticDefinitionsResponse decodeListStatisticDefinitionsResponseResponse(class UPlayFabJsonObject* Response);
	static struct FProgressionUpdateStatisticsResponse decodeUpdateStatisticsResponseResponse(class UPlayFabJsonObject* Response);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabProgressionModelDecoder")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabProgressionModelDecoder")
	}
	static class UPlayFabProgressionModelDecoder* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPlayFabProgressionModelDecoder>();
	}
};
DUMPER7_ASSERTS_UPlayFabProgressionModelDecoder;
...
// Class PlayFab.PlayFabAddonAPI
// 0x02A0 (0x02D0 - 0x0030)
class UPlayFabAddonAPI final : public UOnlineBlueprintCallProxyBase
{
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x228];                                     // 0x0040(0x0228)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0268(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0270(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0278(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_280[0x50];                                     // 0x0280(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UPlayFabAddonAPI* CreateOrUpdateApple(const struct FAddonCreateOrUpdateAppleRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateAppleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateFacebook(const struct FAddonCreateOrUpdateFacebookRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateFacebookResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateFacebookInstantGames(const struct FAddonCreateOrUpdateFacebookInstantGamesRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateFacebookInstantGamesResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateGoogle(const struct FAddonCreateOrUpdateGoogleRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateGoogleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateKongregate(const struct FAddonCreateOrUpdateKongregateRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateKongregateResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateNintendo(const struct FAddonCreateOrUpdateNintendoRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateNintendoResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdatePSN(const struct FAddonCreateOrUpdatePSNRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdatePSNResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateSteam(const struct FAddonCreateOrUpdateSteamRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateSteamResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateToxMod(const struct FAddonCreateOrUpdateToxModRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateToxModResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* CreateOrUpdateTwitch(const struct FAddonCreateOrUpdateTwitchRequest& Request, TDelegate<void(const struct FAddonCreateOrUpdateTwitchResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteApple(const struct FAddonDeleteAppleRequest& Request, TDelegate<void(const struct FAddonDeleteAppleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteFacebook(const struct FAddonDeleteFacebookRequest& Request, TDelegate<void(const struct FAddonDeleteFacebookResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteFacebookInstantGames(const struct FAddonDeleteFacebookInstantGamesRequest& Request, TDelegate<void(const struct FAddonDeleteFacebookInstantGamesResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteGoogle(const struct FAddonDeleteGoogleRequest& Request, TDelegate<void(const struct FAddonDeleteGoogleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteKongregate(const struct FAddonDeleteKongregateRequest& Request, TDelegate<void(const struct FAddonDeleteKongregateResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteNintendo(const struct FAddonDeleteNintendoRequest& Request, TDelegate<void(const struct FAddonDeleteNintendoResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeletePSN(const struct FAddonDeletePSNRequest& Request, TDelegate<void(const struct FAddonDeletePSNResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteSteam(const struct FAddonDeleteSteamRequest& Request, TDelegate<void(const struct FAddonDeleteSteamResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteToxMod(const struct FAddonDeleteToxModRequest& Request, TDelegate<void(const struct FAddonDeleteToxModResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* DeleteTwitch(const struct FAddonDeleteTwitchRequest& Request, TDelegate<void(const struct FAddonDeleteTwitchResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetApple(const struct FAddonGetAppleRequest& Request, TDelegate<void(const struct FAddonGetAppleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetFacebook(const struct FAddonGetFacebookRequest& Request, TDelegate<void(const struct FAddonGetFacebookResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetFacebookInstantGames(const struct FAddonGetFacebookInstantGamesRequest& Request, TDelegate<void(const struct FAddonGetFacebookInstantGamesResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetGoogle(const struct FAddonGetGoogleRequest& Request, TDelegate<void(const struct FAddonGetGoogleResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetKongregate(const struct FAddonGetKongregateRequest& Request, TDelegate<void(const struct FAddonGetKongregateResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetNintendo(const struct FAddonGetNintendoRequest& Request, TDelegate<void(const struct FAddonGetNintendoResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetPSN(const struct FAddonGetPSNRequest& Request, TDelegate<void(const struct FAddonGetPSNResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetSteam(const struct FAddonGetSteamRequest& Request, TDelegate<void(const struct FAddonGetSteamResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetToxMod(const struct FAddonGetToxModRequest& Request, TDelegate<void(const struct FAddonGetToxModResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabAddonAPI* GetTwitch(const struct FAddonGetTwitchRequest& Request, TDelegate<void(const struct FAddonGetTwitchResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);

	void HelperCreateOrUpdateApple(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateFacebook(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateFacebookInstantGames(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateGoogle(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateKongregate(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateNintendo(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdatePSN(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateSteam(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateToxMod(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateOrUpdateTwitch(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteApple(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteFacebook(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteFacebookInstantGames(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteGoogle(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteKongregate(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteNintendo(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeletePSN(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteSteam(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteToxMod(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteTwitch(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetApple(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetFacebook(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetFacebookInstantGames(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetGoogle(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetKongregate(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetNintendo(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetPSN(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetSteam(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetToxMod(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetTwitch(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabAddonAPI")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabAddonAPI")
	}
	static class UPlayFabAddonAPI* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPlayFabAddonAPI>();
	}
};
DUMPER7_ASSERTS_UPlayFabAddonAPI;
...
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x798];                                     // 0x0040(0x0798)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x07D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x07E0(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x07E8(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7F0[0x50];                                     // 0x07F0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static class UPlayFabAdminAPI* DeletePlayerCustomProperties(const struct FAdminDeletePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FAdminDeletePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabAdminAPI* GetPlayerCustomProperty(const struct FAdminGetPlayerCustomPropertyRequest& Request, TDelegate<void(const struct FAdminGetPlayerCustomPropertyResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabAdminAPI* ListPlayerCustomProperties(const struct FAdminListPlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FAdminListPlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabAdminAPI* UpdatePlayerCustomProperties(const struct FAdminUpdatePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FAdminUpdatePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperDeletePlayerCustomProperties(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperGetPlayerCustomProperty(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperListPlayerCustomProperties(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperUpdatePlayerCustomProperties(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
public:
	...
	static struct FAdminDeletePlayerCustomPropertiesResult decodeDeletePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FAdminGetPlayerCustomPropertyResult decodeGetPlayerCustomPropertyResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FAdminListPlayerCustomPropertiesResult decodeListPlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FAdminUpdatePlayerCustomPropertiesResult decodeUpdatePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
...
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0xB28];                                     // 0x0040(0x0B28)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0B68(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0B70(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0B78(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UPlayFabClientAPI* DeletePlayerCustomProperties(const struct FClientDeletePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FClientDeletePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* GetPlayerCustomProperty(const struct FClientGetPlayerCustomPropertyRequest& Request, TDelegate<void(const struct FClientGetPlayerCustomPropertyResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* GetPlayFabIDsFromBattleNetAccountIds(const struct FClientGetPlayFabIDsFromBattleNetAccountIdsRequest& Request, TDelegate<void(const struct FClientGetPlayFabIDsFromBattleNetAccountIdsResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* GetPlayFabIDsFromOpenIdSubjectIdentifiers(const struct FClientGetPlayFabIDsFromOpenIdsRequest& Request, TDelegate<void(const struct FClientGetPlayFabIDsFromOpenIdsResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* GetPlayFabIDsFromSteamNames(const struct FClientGetPlayFabIDsFromSteamNamesRequest& Request, TDelegate<void(const struct FClientGetPlayFabIDsFromSteamNamesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* ListPlayerCustomProperties(const struct FClientListPlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FClientListPlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* LoginWithBattleNet(const struct FClientLoginWithBattleNetRequest& Request, TDelegate<void(const struct FClientLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* UnlinkBattleNetAccount(const struct FClientUnlinkBattleNetAccountRequest& Request, TDelegate<void(const struct FClientEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabClientAPI* UpdatePlayerCustomProperties(const struct FClientUpdatePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FClientUpdatePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperGetPlayFabIDsFromBattleNetAccountIds(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperGetPlayFabIDsFromOpenIdSubjectIdentifiers(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperGetPlayFabIDsFromSteamNames(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperLinkBattleNetAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperLoginWithBattleNet(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperUnlinkBattleNetAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
public:
	...
	static struct FClientDeletePlayerCustomPropertiesResult decodeDeletePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientGetPlayerCustomPropertyResult decodeGetPlayerCustomPropertyResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientGetPlayFabIDsFromBattleNetAccountIdsResult decodeGetPlayFabIDsFromBattleNetAccountIdsResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientGetPlayFabIDsFromOpenIdsResult decodeGetPlayFabIDsFromOpenIdsResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientGetPlayFabIDsFromSteamNamesResult decodeGetPlayFabIDsFromSteamNamesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientListPlayerCustomPropertiesResult decodeListPlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FClientUpdatePlayerCustomPropertiesResult decodeUpdatePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
...
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x338];                                     // 0x0040(0x0338)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0378(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0380(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0388(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UPlayFabEconomyAPI* RedeemAppleAppStoreWithJwsInventoryItems(const struct FEconomyRedeemAppleAppStoreWithJwsInventoryItemsRequest& Request, TDelegate<void(const struct FEconomyRedeemAppleAppStoreWithJwsInventoryItemsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperRedeemAppleAppStoreWithJwsInventoryItems(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
// Class PlayFab.PlayFabProgressionAPI
// 0x0240 (0x0270 - 0x0030)
class UPlayFabProgressionAPI final : public UOnlineBlueprintCallProxyBase
{
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0x1C8];                                     // 0x0040(0x01C8)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0210(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0218(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_220[0x50];                                     // 0x0220(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UPlayFabProgressionAPI* CreateLeaderboardDefinition(const struct FProgressionCreateLeaderboardDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* CreateStatisticDefinition(const struct FProgressionCreateStatisticDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* DeleteLeaderboardDefinition(const struct FProgressionDeleteLeaderboardDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* DeleteLeaderboardEntries(const struct FProgressionDeleteLeaderboardEntriesRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* DeleteStatisticDefinition(const struct FProgressionDeleteStatisticDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* DeleteStatistics(const struct FProgressionDeleteStatisticsRequest& Request, TDelegate<void(const struct FProgressionDeleteStatisticsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetFriendLeaderboardForEntity(const struct FProgressionGetFriendLeaderboardForEntityRequest& Request, TDelegate<void(const struct FProgressionGetEntityLeaderboardResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetLeaderboard(const struct FProgressionGetEntityLeaderboardRequest& Request, TDelegate<void(const struct FProgressionGetEntityLeaderboardResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetLeaderboardAroundEntity(const struct FProgressionGetLeaderboardAroundEntityRequest& Request, TDelegate<void(const struct FProgressionGetEntityLeaderboardResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetLeaderboardDefinition(const struct FProgressionGetLeaderboardDefinitionRequest& Request, TDelegate<void(const struct FProgressionGetLeaderboardDefinitionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetLeaderboardForEntities(const struct FProgressionGetLeaderboardForEntitiesRequest& Request, TDelegate<void(const struct FProgressionGetEntityLeaderboardResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetStatisticDefinition(const struct FProgressionGetStatisticDefinitionRequest& Request, TDelegate<void(const struct FProgressionGetStatisticDefinitionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetStatistics(const struct FProgressionGetStatisticsRequest& Request, TDelegate<void(const struct FProgressionGetStatisticsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* GetStatisticsForEntities(const struct FProgressionGetStatisticsForEntitiesRequest& Request, TDelegate<void(const struct FProgressionGetStatisticsForEntitiesResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* IncrementLeaderboardVersion(const struct FProgressionIncrementLeaderboardVersionRequest& Request, TDelegate<void(const struct FProgressionIncrementLeaderboardVersionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* IncrementStatisticVersion(const struct FProgressionIncrementStatisticVersionRequest& Request, TDelegate<void(const struct FProgressionIncrementStatisticVersionResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* ListLeaderboardDefinitions(const struct FProgressionListLeaderboardDefinitionsRequest& Request, TDelegate<void(const struct FProgressionListLeaderboardDefinitionsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* ListStatisticDefinitions(const struct FProgressionListStatisticDefinitionsRequest& Request, TDelegate<void(const struct FProgressionListStatisticDefinitionsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UnlinkAggregationSourceFromStatistic(const struct FProgressionUnlinkAggregationSourceFromStatisticRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UnlinkLeaderboardFromStatistic(const struct FProgressionUnlinkLeaderboardFromStatisticRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UpdateLeaderboardDefinition(const struct FProgressionUpdateLeaderboardDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UpdateLeaderboardEntries(const struct FProgressionUpdateLeaderboardEntriesRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UpdateStatisticDefinition(const struct FProgressionUpdateStatisticDefinitionRequest& Request, TDelegate<void(const struct FProgressionEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabProgressionAPI* UpdateStatistics(const struct FProgressionUpdateStatisticsRequest& Request, TDelegate<void(const struct FProgressionUpdateStatisticsResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);

	void HelperCreateLeaderboardDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperCreateStatisticDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteLeaderboardDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteLeaderboardEntries(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteStatisticDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperDeleteStatistics(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetFriendLeaderboardForEntity(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetLeaderboard(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetLeaderboardAroundEntity(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetLeaderboardDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetLeaderboardForEntities(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetStatisticDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetStatistics(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperGetStatisticsForEntities(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperIncrementLeaderboardVersion(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperIncrementStatisticVersion(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperListLeaderboardDefinitions(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperListStatisticDefinitions(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUnlinkAggregationSourceFromStatistic(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUnlinkLeaderboardFromStatistic(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUpdateLeaderboardDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUpdateLeaderboardEntries(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUpdateStatisticDefinition(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUpdateStatistics(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayFabProgressionAPI")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayFabProgressionAPI")
	}
	static class UPlayFabProgressionAPI* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPlayFabProgressionAPI>();
	}
};
DUMPER7_ASSERTS_UPlayFabProgressionAPI;
...
public:
	TMulticastInlineDelegate<void(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful)> OnPlayFabResponse; // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_40[0xA08];                                     // 0x0040(0x0A08)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabAuthenticationContext*          CallAuthenticationContext;                         // 0x0A48(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPlayFabJsonObject*                     RequestJsonObj;                                    // 0x0A50(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayFabJsonObject*                     ResponseJsonObj;                                   // 0x0A58(0x0008)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UPlayFabServerAPI* DeletePlayerCustomProperties(const struct FServerDeletePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FServerDeletePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* GetPlayerCustomProperty(const struct FServerGetPlayerCustomPropertyRequest& Request, TDelegate<void(const struct FServerGetPlayerCustomPropertyResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* GetPlayFabIDsFromBattleNetAccountIds(const struct FServerGetPlayFabIDsFromBattleNetAccountIdsRequest& Request, TDelegate<void(const struct FServerGetPlayFabIDsFromBattleNetAccountIdsResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* GetPlayFabIDsFromOpenIdSubjectIdentifiers(const struct FServerGetPlayFabIDsFromOpenIdsRequest& Request, TDelegate<void(const struct FServerGetPlayFabIDsFromOpenIdsResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* GetPlayFabIDsFromSteamNames(const struct FServerGetPlayFabIDsFromSteamNamesRequest& Request, TDelegate<void(const struct FServerGetPlayFabIDsFromSteamNamesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* LinkTwitchAccount(const struct FServerLinkTwitchAccountRequest& Request, TDelegate<void(const struct FServerEmptyResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* LinkXboxId(const struct FServerLinkXboxIdRequest& Request, TDelegate<void(const struct FServerLinkXboxAccountResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* ListPlayerCustomProperties(const struct FServerListPlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FServerListPlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* LoginWithAndroidDeviceID(const struct FServerLoginWithAndroidDeviceIDRequest& Request, TDelegate<void(const struct FServerServerLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* LoginWithBattleNet(const struct FServerLoginWithBattleNetRequest& Request, TDelegate<void(const struct FServerServerLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* LoginWithCustomID(const struct FServerLoginWithCustomIDRequest& Request, TDelegate<void(const struct FServerServerLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* LoginWithIOSDeviceID(const struct FServerLoginWithIOSDeviceIDRequest& Request, TDelegate<void(const struct FServerServerLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* LoginWithTwitch(const struct FServerLoginWithTwitchRequest& Request, TDelegate<void(const struct FServerServerLoginResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* UnlinkBattleNetAccount(const struct FServerUnlinkBattleNetAccountRequest& Request, TDelegate<void(const struct FServerEmptyResponse& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* UnlinkFacebookAccount(const struct FServerUnlinkFacebookAccountRequest& Request, TDelegate<void(const struct FServerUnlinkFacebookAccountResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	static class UPlayFabServerAPI* UnlinkFacebookInstantGamesId(const struct FServerUnlinkFacebookInstantGamesIdRequest& Request, TDelegate<void(const struct FServerUnlinkFacebookInstantGamesIdResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* UnlinkTwitchAccount(const struct FServerUnlinkTwitchAccountRequest& Request, TDelegate<void(const struct FServerEmptyResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	static class UPlayFabServerAPI* UpdatePlayerCustomProperties(const struct FServerUpdatePlayerCustomPropertiesRequest& Request, TDelegate<void(const struct FServerUpdatePlayerCustomPropertiesResult& Result, class UObject* customData)> onSuccess, TDelegate<void(const struct FPlayFabError& Error, class UObject* customData)> onFailure, class UObject* customData);
	...
	void HelperLinkTwitchAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperLinkXboxAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperLinkXboxId(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperListPlayerCustomProperties(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperLoginWithAndroidDeviceID(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperLoginWithBattleNet(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperLoginWithCustomID(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	...
	void HelperUnlinkTwitchAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUnlinkXboxAccount(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUnlockContainerInstance(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUnlockContainerItem(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
	void HelperUpdateAvatarUrl(const struct FPlayFabBaseModel& Response, class UObject* customData, bool successful);
...
public:
	...
	static struct FServerDeletePlayerCustomPropertiesResult decodeDeletePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerGetPlayerCustomPropertyResult decodeGetPlayerCustomPropertyResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerGetPlayFabIDsFromBattleNetAccountIdsResult decodeGetPlayFabIDsFromBattleNetAccountIdsResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerGetPlayFabIDsFromOpenIdsResult decodeGetPlayFabIDsFromOpenIdsResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerGetPlayFabIDsFromSteamNamesResult decodeGetPlayFabIDsFromSteamNamesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerListPlayerCustomPropertiesResult decodeListPlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerUnlinkFacebookAccountResult decodeUnlinkFacebookAccountResultResponse(class UPlayFabJsonObject* Response);
	static struct FServerUnlinkFacebookInstantGamesIdResult decodeUnlinkFacebookInstantGamesIdResultResponse(class UPlayFabJsonObject* Response);
	...
	static struct FServerUpdatePlayerCustomPropertiesResult decodeUpdatePlayerCustomPropertiesResultResponse(class UPlayFabJsonObject* Response);
