...
public:
	...
	TArray<class UGameplayAbility*>               AllReplicatedInstancedAbilities;                   // 0x0558(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected, TObjectPtr)
	...
	TArray<class UAttributeSet*>                  SpawnedAttributes;                                 // 0x10B0(0x0010)(ExportObject, Net, ZeroConstructor, Transient, RepNotify, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
