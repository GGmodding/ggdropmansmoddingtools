...
bool UBinkMediaPlayer::SeekToNextFrame()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "SeekToNextFrame");

	Params::BinkMediaPlayer_SeekToNextFrame Parms{};
...
class FString UBinkMediaPlayer::GetCurrentUrl() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BinkMediaPlayer", "GetCurrentUrl");

	Params::BinkMediaPlayer_GetCurrentUrl Parms{};
