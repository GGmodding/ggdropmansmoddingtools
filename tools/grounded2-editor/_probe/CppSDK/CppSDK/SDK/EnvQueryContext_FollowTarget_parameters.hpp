...
struct EnvQueryContext_FollowTarget_C_ProvideSingleActor final
{
public:
	...
	class ASurvivalAIController*                  K2Node_DynamicCast_AsSurvival_AI_Controller;       // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetFollowTarget_ReturnValue;              // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_EnvQueryContext_FollowTarget_C_ProvideSingleActor;
