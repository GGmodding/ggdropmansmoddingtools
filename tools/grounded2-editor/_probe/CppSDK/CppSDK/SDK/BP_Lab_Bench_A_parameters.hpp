...
struct BP_Lab_Bench_A_C_UserConstructionScript final
{
public:
	EColor_Lab_Props                              Temp_byte_Variable;                                // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_Lab_Bench_A_C_UserConstructionScript;
