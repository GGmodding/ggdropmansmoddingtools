...
struct BP_TaztOverload_C_ExecuteUbergraph_BP_TaztOverload final
{
public:
	...
	float                                         CallFunc_SetIntensity_NewIntensity_ImplicitCast;   // 0x0368(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_TaztOverload_C_ExecuteUbergraph_BP_TaztOverload;
