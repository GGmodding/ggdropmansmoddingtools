...
struct AnimNotifySwimSFX_C_Received_Notify final
{
public:
	...
	bool                                          CallFunc_IsUnderwater_ReturnValue;                 // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_AnimNotifySwimSFX_C_Received_Notify;
