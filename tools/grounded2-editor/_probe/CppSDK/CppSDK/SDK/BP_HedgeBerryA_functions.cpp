...
#include "BP_HedgeBerryA_classes.hpp"
#include "BP_HedgeBerryA_parameters.hpp"
...
void ABP_HedgeBerryA_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, const struct FHitResult& Hit)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_HedgeBerryA_C", "BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");

	Params::BP_HedgeBerryA_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature Parms{};
...
void ABP_HedgeBerryA_C::ExecuteUbergraph_BP_HedgeBerryA(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HedgeBerryA_C", "ExecuteUbergraph_BP_HedgeBerryA");

	Params::BP_HedgeBerryA_C_ExecuteUbergraph_BP_HedgeBerryA Parms{};
...
void ABP_HedgeBerryA_C::OnRep_Squishmode()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_HedgeBerryA_C", "OnRep_Squishmode");
...
void ABP_HedgeBerryA_C::UpdateStaticMesh()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_HedgeBerryA_C", "UpdateStaticMesh");
...
void ABP_HedgeBerryA_C::UserConstructionScript()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("BP_HedgeBerryA_C", "UserConstructionScript");
