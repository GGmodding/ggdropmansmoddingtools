(() => {
  ...
  const FEATURE_MATRIX = [
    ...
    { id: "characters", title: "Character level / AP / lumina / exclude", status: "live", note: "One card per party member (Gustave, Lune, …)" },
    { id: "attributes", title: "Assigned attributes", status: "live", note: "Per-character Vitality/Might/Defense/Luck/Speed" },
    { id: "skills", title: "Skills list", status: "live", note: "Unlocked / equipped skills per character (view)" },
    { id: "weapons", title: "Weapon levels", status: "live", note: "WeaponProgressions CurrentLevel 1–33" },
    { id: "pictos", title: "Pictos", status: "live", note: "Unlock all / master / edit learnt+steps" },
